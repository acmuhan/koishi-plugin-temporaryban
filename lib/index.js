    ...
    if (ctx.console) {
        ...
        ctx.console.addListener('temporaryban/get-stats', async () => {
            try {
                ...
                const totalViolations = await ctx.database.eval('temporaryban_violations', { $count: 'id' });
            ...
            try {
                ...
                if (groupConfig.warningTemplate) {
                    ...
                    warningMsg = groupConfig.warningTemplate
                        .replace(/{at}/g, koishi_1.h.at(userId).toString())
                    ...
                    warningMsg = koishi_1.h.at(userId) + ' ' + detailMsg;
                }
